...
$sat_sub_2= mysqli_escape_string($con, $_POST['sat_sub_3']);
$sat_tec_1= mysqli_escape_string($con, $_POST['sat_tec_1']);
$sat_tec_2= mysqli_escape_string($con, $_POST['sat_tec_2']);
$sat_tec_2= mysqli_escape_string($con, $_POST['sat_tec_3']);
...
$q_15="INSERT INTO `time_table` (`sub_name`, `t_name`, `period`, `day`, `class_id`) VALUES ('$fri_sub_4', '$fri_tec_4', '4', 'Friday', '$class');";
